...
class RedisCache:
    ...
    def __init__(self):
        ...
        if not self.enabled:
            return
        if redis is None:
            logger.warning("REDIS_DISABLED redis package unavailable")
            return
        try:
            ...
            logger.info("REDIS_CONNECTED host=%s port=%s db=%s", os.getenv("REDIS_HOST"), os.getenv("REDIS_PORT"), os.getenv("REDIS_DB"))
        except Exception as e:
            logger.warning("REDIS_UNAVAILABLE fallback_to_local=true error=%s", e)
            self._available = False
            self._client = None
    ...
    def get_json(self, key: str) -> Optional[dict]:
        ...
        try:
            ...
            logger.exception("REDIS_GET_JSON_FAILED key=%s", key)
            return None
    ...
    def set_json(self, key: str, value: dict, ttl_seconds: Optional[int] = None) -> bool:
        ...
        try:
            ...
            logger.exception("REDIS_SET_JSON_FAILED key=%s", key)
            return False
    ...
    def set_json_if_absent(self, key: str, value: dict, ttl_seconds: int) -> bool:
        ...
        try:
            ...
            logger.exception("REDIS_SET_IF_ABSENT_FAILED key=%s", key)
            return False
    ...
    def delete(self, key: str) -> bool:
        ...
        try:
            ...
            logger.exception("REDIS_DELETE_FAILED key=%s", key)
            return False
    ...
    def acquire_lock(self, key: str, owner: str, ttl_seconds: int) -> bool:
        ...
        try:
            ...
            logger.exception("REDIS_LOCK_ACQUIRE_FAILED key=%s", key)
            return False
    ...
    def release_lock(self, key: str, owner: str) -> bool:
        ...
        try:
            ...
            logger.exception("REDIS_LOCK_RELEASE_FAILED key=%s", key)
            return False
